...
def execute(block, config):
    ...
    '''
    fg_params = dict(
        kappa=block["spt3g", "kappa100"] / 100.,
        Dl_Poisson_90x90=block["spt3g", "Dl_Poisson_90x90"],
        Dl_Poisson_90x150=block["spt3g", "Dl_Poisson_90x150"],
        Dl_Poisson_90x220=block["spt3g", "Dl_Poisson_90x220"],
        Dl_Poisson_150x150=block["spt3g", "Dl_Poisson_150x150"],
        Dl_Poisson_150x220=block["spt3g", "Dl_Poisson_150x220"],
        Dl_Poisson_220x220=block["spt3g", "Dl_Poisson_220x220"],
        TDust=block["spt3g", "TDust"],
        ADust_TE_150=block["spt3g", "ADust_TE_150"],
        BetaDust_TE=block["spt3g", "BetaDust_TE"],
        AlphaDust_TE=block["spt3g", "AlphaDust_TE"],
        ADust_EE_150=block["spt3g", "ADust_EE_150"],
        BetaDust_EE=block["spt3g", "BetaDust_EE"],
        AlphaDust_EE=block["spt3g", "AlphaDust_EE"],
        mapTcal90=block["spt3g", "mapTcal90"],
        mapTcal150=block["spt3g", "mapTcal150"],
        mapTcal220=block["spt3g", "mapTcal220"],
        mapPcal90=block["spt3g", "mapPcal90"],
        mapPcal150=block["spt3g", "mapPcal150"],
        mapPcal220=block["spt3g", "mapPcal220"],
    )
